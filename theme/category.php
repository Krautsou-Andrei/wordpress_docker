    ...
    <div class="main-catalog__cards-preview">
      <section class="catalog">
        <div class="catalog__container">
          ...
          <p class="catalog__subtitle">Найдено <span><?php echo get_term(get_queried_object()->term_id, get_queried_object()->taxonomy)->count ?></span> объявлений</p>
                ...
                echo '
                    ...
                    <div class="card-preview__info card-info">
                      <div class="card-info-title-wrapper">
                        <h2 class="card-info__title title--lg title--product-card-preview ">' . $paged . $product_title . '</h2>
